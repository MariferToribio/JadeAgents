Jade Agent for the Simple Linear Regression (SLR) Dataset via the Gradient Descent (GD) adopting an Agent Oriented Approach and an Object Oriented Approach.
